...
void ssd1306_internalInit() {
    ...
    writeRawCommand2(SSD1306_SET_MULTIPLEX_RATIO, 0x7F);                          // Needed for 128x128; can be 0x3F for 128x64, or 0x1F for 128x32
    writeRawCommand2(SSD1306_SET_CONTRAST_CONTROL, 0xDF);                         // Set Contrast Control (0xCF 128x64; external vcc; internal vcc)
